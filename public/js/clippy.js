...
$(function() {
  clippy.load('Clippy', function(agent) {
      ...
      agent.speak('No, you that is NOT a dinosaur in my pocket!');
      agent.play('GetAttention');
      agent.speak('I think you just learn to have a way about yourself, a style of walking down the street, that keeps people away from you.');
      agent.play('Processing');
      agent.speak('I would like to thank our wonderful sponsors.');
      agent.play('GestureDown');
      agent.speak('Did you list a topic to present?');
      agent.play('Save');
      agent.speak('Where is the party gonna be?');
      agent.play('Searching');
      agent.speak('Guess I will start preparing my presentation...');
      agent.play('Writing');
      agent.speak('Do you think people will think I know what I am talking about?');
      agent.play('CheckingSomething');
      agent.speak('Clap your hands everybody, and everybody clap your hands. We are Lambda Lambda Lambda and Omega Mu. We come here on stage tonight to do our show for you. We got a rockin rhythm and a hi-tech sound thatll make you move your body down to the ground. We got Poindexter on the violin, and Lewis and Gilbert will be joining in. We got Booger Presley on the mean guitar and a rap by little ol me Lamar. We got Takashi beating on his gong, the boys and the Mus are clapping along. And just when you thought, ya seen it all, along comes a Lambda four foot tall. So Wormser come on out here on the floor, so we can move our bodies, like never before. Break!');
      agent.play('Congratulate');
      agent.moveTo(9999,9999);
  });
});