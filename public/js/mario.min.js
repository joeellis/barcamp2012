...
"title";this.Images[14].name="worldMap";this.Images[0].src="img/mario/bgsheet.png";this.Images[1].src="img/mario/endscene.gif";this.Images[2].src="img/mario/enemysheet.png";this.Images[3].src="img/mario/firemariosheet.png";this.Images[4].src="img/mario/font.gif";this.Images[5].src="img/mario/gameovergost.gif";this.Images[6].src="img/mario/itemsheet.png";this.Images[7].src="img/mario/logo.gif";this.Images[8].src="img/mario/mapsheet.png";this.Images[9].src="img/mario/mariosheet.png";this.Images[10].src="img/mario/particlesheet.png";
this.Images[11].src="img/mario/racoonmariosheet.png";this.Images[12].src="img/mario/smallmariosheet.png";this.Images[13].src="img/mario/title.gif";this.Images[14].src="img/mario/worldmap.png";Enjine.Resources.AddImages(this.Images);(new Audio).canPlayType("audio/mp3")?Enjine.Resources.AddSound("1up","sounds/1-up.mp3",1).AddSound("breakblock","sounds/breakblock.mp3").AddSound("bump","sounds/bump.mp3",4).AddSound("cannon","sounds/cannon.mp3").AddSound("coin","sounds/coin.mp3",5).AddSound("death","sounds/death.mp3",
